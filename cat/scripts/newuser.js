function newuser(form) {
	...
	if(form.code.value == registercode[0]) {
		...
		alert("Username - 'members', password - 'Private'")/* Member username and password*/
	}
	else {
		alert("Incorrect code. Please re-try or contact Catboomfat for assistance.")/* No such user */
	}
}